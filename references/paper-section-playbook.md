...
- why this work is not just a rename of prior work
...
All numerical claims should point to specific tables, figures, or result files.
...
The conclusion should summarize what was actually shown, not restate the highest hope from the start of the project.
